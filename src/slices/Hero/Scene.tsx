...
export default function Scene({}: Props) {
    ...
    useGSAP(() => {
        if(
            !can1Ref.current || !can2Ref.current || !can3Ref.current || !can4Ref.current || !can5Ref.current || !can1GroupRef.current || !can2GroupRef.current || !groupRef.current
        ) return ;
        ...
        scrollTl
            ...
            // Can 5 - Watermelon
            .to(can5Ref.current.position, {x: 0.3, y: 0.5, z: -.5}, 0)
